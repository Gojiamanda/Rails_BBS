...
class ThresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thre" do
    assert_difference("Thre.count") do
      post thres_url, params: { thre: { board_id: @thre.board_id, context: @thre.context, img_path: @thre.img_path, name: @thre.name, time: @thre.time, title: @thre.title } }
    end
  ...
  test "should update thre" do
    patch thre_url(@thre), params: { thre: { board_id: @thre.board_id, context: @thre.context, img_path: @thre.img_path, name: @thre.name, time: @thre.time, title: @thre.title } }
